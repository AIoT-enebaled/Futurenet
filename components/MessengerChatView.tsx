...
} from "../types"; // Renamed ChatMessage to BotChatMessage
    ...
    <div className="flex flex-col h-full bg-brand-bg">
      {chat ? (
        <>
          ...
          <div
            ref={messagesEndRef}
            className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-1 scrollbar-thin scrollbar-thumb-brand-border scrollbar-track-transparent"
          >
            {messages.map((msg) => (
                    ...
                    <div className="flex items-end gap-2">
                      ...
                      <div className="px-3 py-1.5 rounded-xl shadow-lg bg-brand-surface-alt">
                        <p className="text-xs text-brand-text-muted italic">
                          ...
                          <span className="animate-pulse inline-block animation-delay-200">
                            .
                          </span>
                          <span className="animate-pulse inline-block animation-delay-400">
                            .
                          </span>
                        </p>
                      </div>
