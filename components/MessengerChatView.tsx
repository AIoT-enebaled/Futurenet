...
import { PhoneIcon, VideoIcon as VideoCallIcon, MessageSquareIcon, UsersIcon, DotIcon, ChevronLeftIcon, CircleIcon } from './icons'; 
import { MOCK_MESSENGER_USERS, BOT_AVATAR_URL } from '../constants'; // Removed MOCK_ALL_MESSAGES import
import { generateBotResponse } from '../services/geminiService'; 
import { useNavigate } from 'react-router-dom';\nimport { realtimeMessaging, type RealTimeEvent, type UserPresence } from '../services/realtimeMessagingService';
