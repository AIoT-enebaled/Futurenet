...
const ChatInput: React.FC<ChatInputProps> = ({
  ...
  const canInteract = !!currentUser && apiKeyExists;
  ...
  return (
    ...
    >
      <div
        className={`flex items-end bg-brand-bg rounded-xl p-1.5 border border-brand-border/50 shadow-lg  transition-all 
                      ${
                        canInteract
